...
import { SelectCustomerBike } from "../createNew/repair/SelectCustomerBike";
...
export const Bicycles = () => {
	...
	const emptyRows = page > 0 ? Math.max(0, (1 + page) * rowsPerPage - bicyclesLength) : 0;
	...
	return (
		<Box sx={{ width: "100%" }}>
			<Button
				...
				variant="outlined"
				onClick={() => {
					setModalContent(<SelectCustomerBike />);
					toggleModal();
				}}>
				Create Bicycle
			</Button>
